...
export const KNOWLEDGE_BASE: BotResponse[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    priority: 8,
    fr: "**10 programmes d'immigration couverts:**\n\n**Fédéral (Entrée Express):**\n1. Travailleurs qualifiés fédéral (FSW)\n2. Métiers qualifiés fédéral (FST)\n3. Catégorie expérience canadienne (CEC)\n4. Mobilité francophone\n\n**Québec:**\n5. PSTQ via Arrima\n6. PEQ (Programme expérience québécoise)\n7. Travailleurs temporaires\n\n**Autres:**\n8. Parrainage familial\n9. Programme des candidats des provinces (PNP)\n10. Programme pilote d'immigration atlantique\n\nNotre simulateur évalue votre éligibilité aux **10 programmes** et recommande le meilleur pour votre profil!",
    en: "**10 immigration programs covered:**\n\n**Federal (Express Entry):**\n1. Federal Skilled Worker (FSW)\n2. Federal Skilled Trades (FST)\n3. Canadian Experience Class (CEC)\n4. Francophone Mobility\n\n**Quebec:**\n5. PSTQ via Arrima\n6. PEQ (Quebec Experience Program)\n7. Temporary Workers\n\n**Other:**\n8. Family Sponsorship\n9. Provincial Nominee Program (PNP)\n10. Atlantic Immigration Pilot\n\nOur simulator evaluates your eligibility for all **10 programs** and recommends the best one for your profile!",
  ...
  },
  {
    ...
    priority: 9,
    fr: "**PEQ (Programme de l'expérience québécoise):**\n\nVoie rapide vers la résidence permanente pour ceux qui sont **déjà au Québec**.\n\n**2 volets:**\n1. **Diplômé du Québec** — Diplôme QC admissible + français NCLC 7\n2. **Travailleur temporaire** — 12+ mois d'expérience au QC + français NCLC 7\n\n**Avantages:**\n- Pas de système de pointage (pas besoin de score Arrima)\n- Traitement plus rapide (~20 mois)\n- Pas besoin d'offre d'emploi validée\n\n**Condition clé:** Français NCLC 7 obligatoire pour les deux volets!\n\nC'est pourquoi nos cours de francisation sont essentiels pour le PEQ.",
    en: "**PEQ (Quebec Experience Program):**\n\nFast track to permanent residence for those **already in Quebec**.\n\n**2 streams:**\n1. **Quebec Graduate** — Eligible QC diploma + French NCLC 7\n2. **Temporary Worker** — 12+ months QC experience + French NCLC 7\n\n**Advantages:**\n- No points system (no Arrima score needed)\n- Faster processing (~20 months)\n- No validated job offer needed\n\n**Key requirement:** French NCLC 7 mandatory for both streams!\n\nThat's why our francisation courses are essential for PEQ.",
