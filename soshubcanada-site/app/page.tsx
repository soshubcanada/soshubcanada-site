...
import { PourquoiExpertSection } from '@/components/PourquoiExpertSection';
import {
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32 md:py-40 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6 animate-fade-in-up delay-200">
                ...
                <Link href="/book-online" className="inline-flex items-center justify-center gap-2 px-8 py-4 glass text-white font-semibold rounded-xl hover:bg-white/20 transition-all font-sans">
                  <CalendarClock className="w-4 h-4" /> Réserver une consultation
                </Link>
              </div>
              <div className="mb-10 animate-fade-in-up delay-200">
                <a href="tel:+15145330482" className="inline-flex items-center gap-2 text-white/50 hover:text-white/80 transition-colors text-sm font-sans">
                  <Phone className="w-3.5 h-3.5" /> +1 (514) 533-0482
                </a>
              </div>
