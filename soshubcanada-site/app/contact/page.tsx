            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 space-y-5">
              ...
              {error && (
                <p className="text-red-500 text-sm text-center font-sans">
                  Une erreur est survenue. Veuillez réessayer ou nous contacter par téléphone au +1 (514) 533-0482.
                </p>
              )}
      ...
      <section className="pb-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2794.5!2d-73.6128!3d45.5478!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4cc91f0e0b0b0b0b%3A0x0!2s3737+Cr%C3%A9mazie+Est%2C+Montr%C3%A9al%2C+QC+H1Z+2K4!5e0!3m2!1sfr!2sca!4v1"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="SOS Hub Canada - 3737 Crémazie Est, Montréal"
            />
          </div>
        </div>
      </section>
      ...
      <section className="pb-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-navy rounded-2xl p-8 md:p-12 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Espace Client</h2>
            <p className="text-white/60 mb-8 max-w-xl mx-auto font-sans">
              Accédez à votre portail client pour suivre votre dossier, télécharger vos documents et communiquer avec votre conseiller.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://soshubca.vercel.app/inscription" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://soshubca.vercel.app/client" target="_blank" rel="noopener noreferrer"
