      ...
      <header className={`sticky top-0 z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/book-online"
              className="hidden md:inline-flex px-5 py-2.5 border-2 border-navy text-navy text-sm font-semibold rounded-xl hover:bg-navy hover:text-white transition-all font-sans"
            >
              Réserver
            </Link>
            <Link
            ...
            <nav className="max-w-7xl mx-auto px-6 py-4 space-y-1">
              ...
              <div className="pt-4 space-y-2 border-t border-gray-100 mt-2">
                ...
                <Link
                  href="/book-online"
                  onClick={() => setOpen(false)}
                  className="block text-center px-5 py-3 border-2 border-navy text-navy font-semibold rounded-xl hover:bg-navy hover:text-white transition-all font-sans"
                >
                  Réserver
                </Link>
                <Link
